  ...
  return (
    <nav className="sticky top-0 z-[999] bg-slate-900 text-white shadow-xl print:hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b-2 border-slate-950">
        <button 
          onClick={onExit}
          className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 px-3 h-10 rounded-xl border-2 border-slate-600 font-black transition-all active:scale-95 text-yellow-400 group cursor-pointer"
        >
          <ChevronLeft size={16} />
